...
fn main() {
    ...
    // A mutable variable's type can also be changed
    let mut mutable = 12; // Mutable i32
    mutable = 21; // Still i32
    mutable = 3.14; // Now f64
    ...
    /*  Shadowing allows you to reuse the same variable name
       without needing to create a new one. This can be useful
       in situations where you want to change the value of a
    ...
    // Tuple is a collection of values of different types and is contructed using parenthese ()
    let my_tuple: (i32, f64, char) = (1, 2.0, 'a');
    // Accessing tuple elements
    let (x, y, z) = my_tuple;

    let my_tuple2 = (5u32, 1u8, true, -5.04f32);
}