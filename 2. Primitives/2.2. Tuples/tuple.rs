...
fn reverse(pair: (i32, bool)) -> (bool, i32) {
    // `let` can be used to build the members of a tuple to variables
    let (int_param, bool_param) = pair;

    (bool_param, int_param)
}

// The following struct is for the acivity
#[derive(Debug)]
...
fn main() {
    ...
    // Values can be extrated from the tuple using tuple indexing
