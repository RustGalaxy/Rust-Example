...
//Printing is handle by a series of macros defined in "std::fmt" some of which are:
      // format! : write formatted text to String
      // print! : same as format! but the text is printed to the console(id::stdout).
      // println! : same as print! but a newline is appended.
      // eprint! : same as print! but the text is printed to the standard error (id::stderr).
...
fn main() {
    ...
    println!("Base 1 (binary):  {:b}", 69420) // 10000111100101100
    ...
    // You can use name arguments in the format specifier by appending a `$`.
